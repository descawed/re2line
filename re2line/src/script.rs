...
pub enum Instruction {
    ...
    ObjModelSet {
        ...
        dir_y: Fixed12,
        dir_z: Fixed12,
        atari_offset_x: Fixed12,
        atari_offset_y: Fixed12,
        atari_offset_z: Fixed12,
        atari_size_x: Fixed12,
        atari_size_y: Fixed12,
        atari_size_z: Fixed12,
    },
    #[brw(magic = 0x2Eu8)]
    ...
    AddASpeed,
    #[brw(magic = 0x32u8)]
    PosSet { align: u8, pos_x: Fixed12, pos_y: Fixed12, pos_z: Fixed12 },
    #[brw(magic = 0x33u8)]
    DirSet { align: u8, dir_x: Fixed12, dir_y: Fixed12, dir_z: Fixed12 },
    #[brw(magic = 0x34u8)]
    MemberSet { destination: u8, source: i16 },
    #[brw(magic = 0x35u8)]
    MemberSet2 { destination: u8, source: u8 },
    #[brw(magic = 0x36u8)]
    SeOn { vab: u8, edt: i16, data0: i16, x: Fixed12, y: Fixed12, z: Fixed12 },
    #[brw(magic = 0x37u8)]
    ScaIdSet { i_entry: u8, id: u16 },
    #[brw(magic = 0x38u8)]
    FlrSet { id: u8, flag: u8 },
    #[brw(magic = 0x39u8)]
    DirCk { align: u8, x: Fixed12, z: Fixed12, add: i16 },
    #[brw(magic = 0x3Au8)]
    SceEsprOn { align: u8, data0: u16, data1: u16, data2: u16, x: Fixed12, y: Fixed12, z: Fixed12, dir_y: Fixed12 },
    #[brw(magic = 0x3Bu8)]
    DoorAotSet {
        aot: u8,
        sce: u8,
    ...
    #[brw(magic = 0x40u8)]
    PlcDest { align: u8, animation: u8, bit: u8, x: Fixed12, z: Fixed12 },
    #[brw(magic = 0x41u8)]
    PlcNeck { op: u8, x: Fixed12, y: Fixed12, z: Fixed12, speed_x: u8, speed_z: u8 },
    #[brw(magic = 0x42u8)]
    PlcRet,
    #[brw(magic = 0x43u8)]
    ...
    #[brw(magic = 0x49u8)]
    SuperReset { align: u8, d_x: Fixed12, d_y: Fixed12, d_z: Fixed12 },
    #[brw(magic = 0x4Au8)]
    PlcGun(u8),
    #[brw(magic = 0x4Bu8)]
    ...
    #[brw(magic = 0x6Au8)]
    LightPosSet { align: u8, index: u8, xyz: u8, position: Fixed12 },
    #[brw(magic = 0x6Bu8)]
